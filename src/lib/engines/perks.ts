export const PerkHelpLookup = {
  ...
  'Flower Child':
    'With this Perk, you are less likely to be reliant to chems (50% less likely, actually), and you suffer half the withdrawal time of a normal person.',
  Pathfinder:
  ...
  'Quick Pockets':
    'You have learned to pack your equipment better.  Accessing your inventory only costs you 2 Action Points in Combat instead of 4.',
  'Smooth Talker':
  ...
  'Nuka-Cola Reliance': 'You crave another Nuka-Cola.',
  'Buffout Reliance': "You've got the shakes.",
  'Mentats Reliance': 'You feel groggy.',
  'Psycho Reliance': 'You feel light-headed.',
  'Radaway Reliance': 'You feel nauseous.',
  'Weapon Long Range': 'Weapon Long Range',
  'Weapon Accurate': 'Weapon Accurate',
  'Weapon Penetrate': 'Weapon Penetrate',
  'Weapon Knockback': 'Weapon Knock-back',
  'Powered Armor': 'Powered Armor',
  'Combat Armor': 'Combat Armor',
  'Weapon Scope Range': 'Weapon Scope Range',
  'Weapon Fast Reload': 'Weapon Fast Reload',
  'Weapon Night Sight': 'Weapon Night Sight',
  'Weapon Flameboy': 'Weapon Flameboy',
  'Armor Advanced I': 'Armor Advanced I',
  'Armor Advanced II': 'Armor Advanced II',
  'Jet Reliance':
  ...
  'Gain Strength': 'With this Perk you gain +1 to your Strength.',
  'Gain Perception': 'With this Perk you gain +1 to your Perception.',
  'Gain Endurance': 'With this Perk you gain +1 to your Endurance.',
  'Gain Charisma': 'With this Perk you gain +1 to your Charisma.',
  'Gain Intelligence': 'With this Perk you gain +1 to your Intelligence.',
  'Gain Agility': 'With this Perk you gain +1 to your Agility.',
  'Gain Luck': 'With this Perk you gain +1 to your Luck.',
  Harmless:
    'Your innocent demeanor makes stealing from people a little easier. You gain 20% to your Steal skill.',
  'Here and Now': 'With this Perk you immediately gain one experience level.',
  'HtH Evade':
  ...
  'Magnetic Personality':
    "You get 1 extra slot in your companion limit, but don't forget that more than 5 is always a crowd.",
  Negotiator:
  ...
  'Quick Recovery': 'You are quick at recovering from being knocked down.',
  Salesman:
    'You are an adept salesperson.  With this Perk you gain +20% towards your Barter skill.',
  Stonewall: 'You are much less likely to be knocked down in combat.',
  Thief:
  ...
  'Vault City Training': 'You have received the Vault City medical training.',
  'Alcohol Raised hit points':
    'Your hit points have been enhanced a little by repeated drunkenness.',
  'Alcohol Raised hit points II':
    'Your hit points have been enhanced a little more by repeated drunkenness.',
  'Alcohol Lowered hit points':
    'Your hit points have been lowered slightly by repeated drunkenness.',
  'Alcohol Lowered hit points II':
    'Your hit points have been lowered slightly by repeated drunkenness.',
  'Autodoc Raised hit points':
    'Your hit points have been enhanced a little by repeated use of the autodoc.',
  'Autodoc Raised hit points II':
    'Your hit points have been enhanced a little more by repeated use of the autodoc.',
  'Autodoc Lowered hit points':
    'Your hit points have been lowered slightly by repeated use of the autodoc.',
  'Autodoc Lowered hit points II':
    'Your hit points have been lowered slightly by repeated use of the autodoc.',
  'Expert Excrement Expeditor': 'You can sling bull with the best of them.',
  'Weapon Enhanced Knockout': 'Weapon Enhanced Knockout'
};
