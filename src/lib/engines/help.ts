export const CharacterHelpLookup = {
  ...
  "Action Points": "The number of actions that the character can take during one combat turn.",
  ...
  "Damage Res.": "Any damage taken is reduced by this amount. Damage Resistance can be increased by wearing armor.",
