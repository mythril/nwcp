export const CharacterHelpLookup = {
  ...
  "Hit Points": "How much damage your character can take before dying.  If you reach 0 HP or less, you are dead.",
  "Maximum Action Points": "The number of actions that the character can take during one combat turn.",
  "Armor Class": "Modifies the chance to hit this particular character.",
  "Unarmed Damage": "The amount of bonus damage your character does in hand-to-hand combat.",
  "Melee Damage": "The amount of bonus damage your character does in hand-to-hand combat.",
  "Carry Weight": "The maximum amount of equipment your character can carry, in pounds.",
  "Sequence": "Determines how soon in a combat turn your character can react.",
  "Healing Rate": "At the end of each day, your character will heal 1 HP for each point of Healing Rate.  When you rest, you heal every six hours.",
  "Critical Chance": "The chance to cause a critical hit in combat is increased by this amount.",
  ...
  "Damage Resistance": "Any damage taken is reduced by this amount. Damage Resistance can be increased by wearing armor.",
  ...
  "Radiation Resistance": "The amount of radiation you are exposed to is reduced by this percentage. Radiation Resistance can be modified by the type of armor worn, and anti-radiation chems.",
  "Poison Resistance": "Reduces poison damage by this amount.",
  "Age": "Age",
  "Gender": "Gender",
  ...
  "Character Points": "Amount of free character points that can be added to one of the basic stats.",
  "Next Level": "The amount of experience points needed to move up to the next level.",
  "Perks": "Perks add additional abilities. Every third experience level, you can choose one perk.",
  ...
  "Skills": "Skills are learned knowledge.  Skills increase by experience, or during the course of the game by special events.  The higher the skill level, the better you are at that skill.",
  "Tag Skills": "Tag skills are skills your character specializes in.  Each tag skill gains +20%, and increases twice as fast.  You must pick three tag skills.",
  "Optional Traits": "Optional traits describe your character in more detail.  All traits will have positive and negative effects.  You may choose up to two traits during creation.",
  "Poisoned": "Your character has been poisoned.  Poison will do damage over a period of time, until cured or it passes from your system.",
  "Radiated": "Your character is suffering from a significant amount of Radiation poisoning.  The more radiation damage, the more deadly the effect.",
  "Eye Damage": "This means your character has been seriously hit in one or both of your eyes.  This affects your Perception.",
  "Crippled Right Arm": "The right arm has been severely hurt, and cannot function well.  If one arm has been crippled, you cannot use two-handed weapons.  If both arms have been crippled, you cannot attack with weapons.",
  "Crippled Left Arm": "Your character's left arm has been severely hurt, and cannot function well.  If one arm has been crippled, you cannot use two-handed weapons.  If both arms have been crippled, you cannot attack with weapons.",
