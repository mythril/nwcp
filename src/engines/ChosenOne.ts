...
export function SpecialAbbreviation(special: Special): string {
    switch(special) {
        case Special.Strength: return "ST";
        case Special.Perception: return "PE";
        case Special.Endurance: return "EN";
        case Special.Charimsa: return "CH";
        case Special.Intelligence: return "IN";
        case Special.Agility: return "AG";
        case Special.Luck: return "LK";
    }
}
